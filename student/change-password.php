<?php
    ...
    $username=$_SESSION['stulogin'];
        $sql ="SELECT Password FROM students WHERE EmailId=:username and Password=:password";
    ...
    $con="UPDATEstudents set Password=:newpassword where EmailId=:username";
