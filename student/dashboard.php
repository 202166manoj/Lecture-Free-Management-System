...
<?php
    ...
    if(strlen($_SESSION['stulogin'])==0){   
        ...
        // Fetch the logged-in student's full name from the database
        $stuid = $_SESSION['stulogin'];
        $sql = "SELECT FullName FROM students WHERE StuId = :stuid";
            ...
            <!-- page title area end -->
                ...
                <div class="sales-report-area mt-5 mb-5">
                    <div class="row">
                        <div class="cong-box">
                            <div class="content">
                            <p class="head">Welcome <?php echo htmlentities($fullName); ?></p><br>
                            <p>Balancing your academic responsibilities with your passions and commitments just got easier.<br>Submit your request today and take full control of your schedule</p>
                            <a href="forms.php"><button class="btn">Try it Now</button></a>
