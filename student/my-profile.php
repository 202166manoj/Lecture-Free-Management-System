...
if (strlen($_SESSION['stulogin']) == 0) {
    ...
    if (isset($_POST['update'])) {
        ...
        // Update the database
        $sql = "UPDATE students SET FullName=:fname, Dob=:dob, level=:level, Phonenumber=:mobileno";
    ...
    <div class="page-container">
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="my-profile.php"><img src="../assets/images/logo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                                ...
                                <div class="card">
                                    <form name="addemp" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            ...
                                            <?php
                                            $eid = $_SESSION['stulogin'];
                                            $sql = "SELECT * from students where StuId=:eid";
                                            $query = $dbh->prepare($sql);
                                            $query->bindParam(':eid', $eid, PDO::PARAM_STR);
                                            $query->execute();
                                            ...
                                            ?>
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" name="stucode" type="text" autocomplete="off" readonly required value="<?php echo htmlentities($result->StuId); ?>" id="example-text-input">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="custom-select" name="level" autocomplete="off">
