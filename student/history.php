                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <div class="nav-btn pull-left">
                            ...
                            <h4 class="page-title pull-left">My Forms</h4>
            ...
            <!-- page title area end -->
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="header-title">My Forms</h4>
                                ...
                                <div class="data-tables datatable-dark">
                                    <table id="dataTable3" class="table table-hover table-striped text-center">
                                        ...
                                        <?php 
                                        $eid=$_SESSION['eid'];
                                        $sql = "SELECT Subject,Teacher,Sport,Date,FromTime,ToTime,PostingDate,AdminStatus, TeacherStatus from forms where stuid=:eid";
