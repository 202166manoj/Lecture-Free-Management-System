...
<?php
    ...
    if(strlen($_SESSION['inslogin'])==0){   
        ...
        $email = $_SESSION['inslogin'];
        $sql = "SELECT FullName FROM instructors WHERE EmailId = :email";
        $query = $dbh->prepare($sql);
        $query->bindParam(':email', $email, PDO::PARAM_STR);
        $query->execute();
        $result = $query->fetch(PDO::FETCH_OBJ);
        $instructorName = $result->FullName;
?>
...
<head>
    ...
    <title>Instructor Panel - Dashboard</title>
            ...
            <!-- page title area end -->
                ...
                <div class="sales-report-area mt-5 mb-5">
                    <div class="row">
                        <div class="cong-box">
                            <div class="content">
                            <p class="head">Welcome <?php echo htmlspecialchars($instructorName); ?></p><br>
