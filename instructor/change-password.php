<?php
    ...
    $username=$_SESSION['inslogin'];
        $sql ="SELECT Password FROM instructors WHERE EmailId=:username and Password=:password";
    ...
    $con="UPDATE instructors set Password=:newpassword where EmailId=:username";
    ...
    <div class="page-container">
        ...
        <div class="sidebar-menu">
            <div class="sidebar-header">
                <div class="logo">
                    <a href="dashbaord.php"><img src="../assets/images/logo.png" alt="logo"></a>
                </div>
            </div>
            <div class="main-menu">
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <div class="nav-btn pull-left">
                            ...
                            <h4 class="page-title pull-left">Change My Password</h4>
