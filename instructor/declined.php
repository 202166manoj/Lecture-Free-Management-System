<?php
    ...
    if (strlen($_SESSION['inslogin']) == 0) {
        ...
        // Get the instructor's sport
        $instructor_id = $_SESSION['eid']; // Assuming 'eid' stores the instructor's ID in the session
        // Fetch the sport associated with the logged-in instructor
        $sql = "SELECT Sport FROM instructors WHERE id=:instructor_id";
        $query = $dbh->prepare($sql);
        $query->bindParam(':instructor_id', $instructor_id, PDO::PARAM_STR);
        $query->execute();
        $result = $query->fetch(PDO::FETCH_OBJ);
        $instructor_sport = $result->Sport;
        ?>
...
<head>
    ...
    <title>Instructor Panel - Declined Forms</title>
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <div class="nav-btn pull-left">
                            ...
                            <h4 class="page-title pull-left">Declined Forms</h4>
                ...
                <div class="row">
                    ...
                    <!-- trading history area start -->
                                ...
                                <div class="col-12 mt-5">
                                    <div class="card">
                                        <div class="card-body">
                                        <h4 class="header-title">Declined Forms</h4>
                                            ...
                                            <table id="dataTable3" class="table table-hover table-striped text-center">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT forms.id as lid, students.StuId, forms.Subject, forms.Sport, forms.Date, forms.PostingDate, forms.TeacherStatus, forms.AdminStatus 
                                                            ...
                                                            WHERE forms.Sport = :instructor_sport 
                                                            AND forms.AdminStatus=:status
                                                            ORDER BY lid DESC";
                                                    $query = $dbh->prepare($sql);
                                                    $query->bindParam(':instructor_sport', $instructor_sport, PDO::PARAM_STR);
