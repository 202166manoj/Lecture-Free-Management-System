...
if(isset($_POST['signin']))
{
    ...
    $sql ="SELECT StuId,Password,Status,id FROM students WHERE StuId=:stuid and Password=:password";
...
<head>
    ...
    <title>WayaSync | Student Login</title>
</head>
<body>
    <div class="container">
            ...
            <div class="content">
                ...
                <div class="form__content">
                    ...
                    <p class="form__subtitle">
                        Welcome! Please fill your Student ID and password to sign in to your account.
                    </p>
                    <form method="POST" name="signin">
                        <input type="text" id="stuid" name="stuid" placeholder="Student ID" autocomplete="off" required />
