...
if(isset($_POST['signin']))
{
        ...
        $sql ="SELECT EmailId,Password,Status,id FROM instructors WHERE EmailId=:uname and Password=:password";
    ...
    if($query->rowCount() > 0)
    {
        ...
        if($status==0)
        {
            ...
            $_SESSION['inslogin']=$_POST['email'];
            echo "<script type='text/javascript'> document.location = 'instructor/dashboard.php'; </script>";
        }
    } else  {
...
<head>
    ...
    <title>WayaSync | Instructor Login</title>
</head>
<body>
    <div class="container">
