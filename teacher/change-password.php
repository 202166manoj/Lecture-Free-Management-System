<?php
    ...
    $username=$_SESSION['tealogin'];
        $sql ="SELECT Password FROM teachers WHERE EmailId=:username and Password=:password";
    ...
    $con="UPDATE teachers set Password=:newpassword where EmailId=:username";
