<?php
    ...
    $teacheractiondate=date('Y-m-d G:i:s ', strtotime("now"));
    $sql="UPDATE forms set IsReadByTeacher=:isreadbyteacher where id=:did";
    ...
    $did=intval($_GET['formid']);
    $teacherstatus=$_POST['status'];   
    $teacherremark=$_POST['teacherremark'];
    date_default_timezone_set('Asia/Kolkata');
    $teacheractiondate=date('Y-m-d G:i:s ', strtotime("now"));

    $sql="UPDATE forms set TeacherRemark=:teacheremark,TeacherStatus=:teacherstatus,TeacherActionDate=:teacheractiondate where id=:did";
    $query = $dbh->prepare($sql);
    $query->bindParam(':adminremark',$adminremark,PDO::PARAM_STR);
    $query->bindParam(':teacherstatus',$teacherstatus,PDO::PARAM_STR);
    $query->bindParam(':teacheractiondate',$teacheractiondate,PDO::PARAM_STR);
    $query->bindParam(':did',$did,PDO::PARAM_STR);
    $query->execute();
                    ...
                    <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                        ...
                        <div class="card">
                            ...
                            <div class="modal-dialog" role="document">
                                ...
                                <form method="POST" name="teacheraction">
