...
if(isset($_POST["upload"])) {
    ...
    if ($_FILES["file"]["size"] > 0) {
        ...
        $msg = "Lecturers have been added successfully.";
    } else {
...
<head>
    ...
    <title>Admin Panel - Upload Lecturers</title>
                            ...
                            <div class="col-12 mt-5">
                                ...
                                <div class="card">
                                    <form name="uploadCSV" method="POST" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <p class="text-muted font-14 mb-4">Please upload a CSV file to add multiple Lecturers</p>
