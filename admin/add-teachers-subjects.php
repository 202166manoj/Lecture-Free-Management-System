<?php
    ...
    $sql = "INSERT INTO teacher_subjects(teacher_id, subject_id, method) VALUES(:teacher_id, :subject_id, :method)";
    $query = $dbh->prepare($sql);
    $query->bindParam(':teacher_id', $teacher_id, PDO::PARAM_INT);
    $query->bindParam(':subject_id', $subject_id, PDO::PARAM_INT);
    $query->bindParam(':method', $method, PDO::PARAM_STR);  // Corrected here
    $query->execute();
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form method="POST">
                                 <div class="card-body">
                                        ...
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to assign lecturers to subjects</p>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="method" autocomplete="off">
