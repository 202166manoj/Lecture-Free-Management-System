...
<head>
    ...
    <title>Admin Panel - Student Section</title>
                    ...
                    <div class="col-12 mt-5">
                        ...
                        <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                            ...
                            <div class="card-body">
                                ...
                                <center><a href="add-students.php" class="btn btn-sm btn-info">Add New Students</a></center>
                                    ...
                                    <?php 
                                    $sql = "SELECT StuId,FullName,level,EmailId,Status,RegDate,id from  students";
                                    $query = $dbh -> prepare($sql);
                                    $query->execute();
                                    ...
                                    {               ?>  
                                        ...
                                        <tr>
                                            ...
                                            <td><a href="update-students.php?stuid=<?php echo htmlentities($result->id);?>"><i class="fa fa-edit" style="color:green"></i></a>
