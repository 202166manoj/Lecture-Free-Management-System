<?php
    ...
    $eid=intval($_GET['insid']);
    $fname=$_POST['fullname'];  
    $sport=$_POST['sport']; 
    $mobileno=$_POST['mobileno'];

    $sql="UPDATE instructors set FullName=:fname,Sport=:sport,Phonenumber=:mobileno where id=:eid";
    ...
    $msg="Instructor record updated Successfully";
    }
...
<head>
    ...
    <title>Admin Panel - Manage Instructors</title>
                ...
                <div class="col-lg-6 col-ml-12">
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <div class="card">
                                <form name="addtea" method="POST">

                                    <div class="card-body">
                                        
                                        <p class="text-muted font-14 mb-4">Please make changes on the form below in order to update teacher profile</p>

                                        <?php 
                                            $eid=intval($_GET['insid']);
                                            $sql = "SELECT * from  instructors where id=:eid";
                                            $query = $dbh -> prepare($sql);
                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                            $query->execute();
                                        ...
                                        <div class="form-group">
                                            <label for="example-email-input" class="col-form-label">Sport</label>
                                            <input class="form-control" name="sport" type="email"  value="<?php echo htmlentities($result->Sport);?>" readonly autocomplete="off" required id="example-email-input">
                                        </div>
