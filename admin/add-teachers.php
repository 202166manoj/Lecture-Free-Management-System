<?php
    ...
    $sql="INSERT INTO teachers(FullName,EmailId,Password,department,Phonenumber,Status) VALUES(:fname,:email,:password,:department,:mobileno,:status)";
...
<head>
    ...
    <script type="text/javascript">
        function valid(){
            if(document.addtea.password.value!= document.addtea.confirmpassword.value) {
            alert("New Password and Confirm Password Field do not match  !!");
            document.addtea.confirmpassword.focus();
            return false;
                } return true;
        }
    </script>
                        ...
                        <div class="row">
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addtea" method="POST">
                                    ...
                                    <div class="card-body">
                                        <p class="text-muted font-14 mb-4">Please fill up the form in order to add teachert records</p>
                                        <center><a href="upload-teachers.php" class="btn btn-sm btn-info">Add Multiple Lecturers</a></center>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="custom-select" name="department" autocomplete="off">
                                                ...
                                                <option value="Computing & Informations Systems">Computing & Informations Systems</option>
