<?php
    ...
    $eid=intval($_GET['teaid']);
    $fname=$_POST['fullname'];  
    $department  =$_POST['department']; 
    $mobileno=$_POST['mobileno'];

    $sql="UPDATE teachers set FullName=:fname,department=:department,Phonenumber=:mobileno where id=:eid";
...
<head>
    ...
    <title>Admin Panel - Manage Teachers</title>
                            ...
                            <?php if($error){?><div class="alert alert-danger alert-dismissible fade show"><strong>Info: </strong><?php echo htmlentities($error); ?>
                                ...
                                <form name="addtea" method="POST">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <?php 
                                            $eid=intval($_GET['teaid']);
                                            $sql = "SELECT * from  teachers where id=:eid";
                                            $query = $dbh -> prepare($sql);
                                            $query -> bindParam(':eid',$eid, PDO::PARAM_STR);
                                            $query->execute();
