                ...
                <div class="row">
                    ...
                    <!-- trading history area start -->
                                ...
                                <div class="col-12 mt-5">
                                    <div class="card">
                                        <div class="card-body">
                                        <h4 class="header-title">Lecture Free Forms</h4>
                                        ...
                                        <div class="data-tables datatable-dark">
                                            <table id="dataTable3" class="table table-hover table-striped text-center">
                                                ...
                                                <?php 
                                                    ...
                                                    $sql = "SELECT forms.id as lid,students.StuId,forms.Subject,forms.Sport,forms.Date,forms.PostingDate,forms.AdminStatus,forms.TeacherStatus from forms join students on forms.stuid=students.id order by lid desc";
